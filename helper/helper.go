...
func BookTickets(firstName string, lastName string, email string, userTickets int, remainingTickets uint, bookings []string, conferenceName string) (uint, []string) {
